    ...
    public function editQuestions(): void
    {
        ...
        if ($this->request->getMethod() === 'POST') {
            ...
            if (isset($post_data['markdown_content'])) {
                $this->object->setMarkdownContent($markdown_content);
                $this->object->update();
...
CSS;
    ...
    public function generate(): void
    {
        ...
        $question_count_field = $this->factory->input()->field()->numeric($this->plugin->txt('ai_label_question_count'), $this->plugin->txt('ai_desc_question_count'))
            ->withValue(3)
            ->withAdditionalTransformation(
