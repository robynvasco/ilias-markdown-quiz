...
/**
 * Access Control for MarkdownQuiz Plugin
 * 
 * Handles access permissions and online/offline visibility for quiz objects.
 * 
 * Key Features:
...
class ilObjMarkdownQuizAccess extends ilObjectPluginAccess
{
     ...
     * 
     * @param string $target Target string format: "xmdq_<ref_id>"
    ...
    /**
     * Check if a quiz object is offline
     * 
